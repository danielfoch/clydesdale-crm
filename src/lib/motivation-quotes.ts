...
export const defaultMotivationQuotes = [
  ...
  { source: "Belal Batrawy", text: "Control what you can control: your list, your tone, your effort." },
  { source: "Ian Koniak", text: "Focus on making your customers as successful as possible." },
  ...
  { source: "Jill Konrath", text: "Know your buyer's journey and align with it." },
  ...
  { source: "Og Mandino", text: "I will persist until I succeed." },
  { source: "Nelson Mandela", text: "It always seems impossible until it is done." },
  { source: "Oprah Winfrey", text: "Where there is no struggle, there is no strength." },
